function Remove-MultipleFollowedUsers {
    <#
  .SYNOPSIS
    Unfollow multiple Users
  .EXAMPLE
    PS C:\> Remove-MultipleFollowedUsers -Username "xyz" -UserArray @("id1","id2")
    Remove users with Ids "id1" and "id2" to follow for the user authed under the current access token
  .PARAMETER Username
  ...
  #>
    ...
    Write-Verbose 'Attempting to unfollow those users'
    $Method = 'Delete'
